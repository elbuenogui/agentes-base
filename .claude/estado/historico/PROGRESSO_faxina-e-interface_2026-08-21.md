# PROGRESSO — plano de faxina e interface enxuta (2026-08-21)

> Arquivo do `PROGRESSO.md` vivo na virada de plano de 2026-08-21 (abertura da Fase 1 do
> SDD). Entradas movidas palavra por palavra, sem edição: as 3 do plano de faxina e a do
> pedido ad hoc do interruptor "Recortar em vez de copiar". Plano correspondente em
> `PLANO_2026-08-21c_faxina-encerrado.md`.
