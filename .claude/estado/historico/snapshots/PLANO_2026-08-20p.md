...
5. [Reorganização da interface de gravação] — pedido do usuário em 2026-08-20, depois de usar a
   ...
   > em andamento**, não notificação — precisam durar enquanto a ação dura, senão o usuário fica
   > olhando uma tela parada sem saber se travou, justamente enquanto o app espera a API.
